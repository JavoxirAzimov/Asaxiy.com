...
export default function Footer() {
  ...
  return (
    <div className='footer-container'>
      ...
      <div className="footer-middle-container">
        ...
        <div className="footer-middle-item">
          <h5>{t('footerLang.footer18')}</h5>
            <ul>
              <li><a href="tel:+998901930535"><HiOutlinePhone style={{fontSize:"23px",marginRight:"10px"}}/>+998 91 536 04 26</a></li>
              <li><a href="#"><HiOutlineMail style={{fontSize:"23px",marginRight:"10px"}}/>info@asaxiy.uz</a></li>
              <li><a href="#"><HiOutlineLocationMarker style={{fontSize:"23px",marginRight:"10px"}}/>Sarteppo atlas,Samarqand</a></li>
            </ul>
        </div>
        <div className="footer-middle-item">
      ...
      <p style={{textAlign:"center", color:"#fff",marginTop:"30px"}}>&copy;2023-2030 All right reserved by Azimov Javoxir | Frontend Developer </p>
    </div>
  )
}
